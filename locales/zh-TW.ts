export default {
    ...
    notice: {
        ...
        mobileRefreshCookieInDesktop: "手機端不支援刷新 cookie，請在桌面端操作",
    ...
    error: {
        ...
        waitWebviewerOpenTimeout: "等待 Web viewer 開啟逾時",
        waitWebviewInitTimeout: "等待 Web viewer 初始化 webview 逾時",
        waitWebviewDomReadyTimeout: "等待 Web viewer dom-ready 逾時",
        cannotAccessElectronWebContents: "無法存取 Electron webContents",
